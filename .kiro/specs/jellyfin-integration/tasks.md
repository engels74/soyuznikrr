...
- [x] 1. Implement JellyfinClient core functionality
  - [x] 1.1 Implement connection management and test_connection
    ...
    - [x] 1.1.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
  ...
  - [x] 1.2 Implement get_libraries method
    ...
    - [x] 1.2.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
  ...
  - [x] 1.3 Write property test for library mapping
    ...
    - [x] 1.3.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
...
- [x] 2. Implement JellyfinClient user management
  - [x] 2.1 Implement create_user method
    ...
    - [x] 2.1.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
  ...
  - [x] 2.2 Implement delete_user method
    ...
    - [x] 2.2.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
  ...
  - [x] 2.3 Implement set_user_enabled method
    ...
    - [x] 2.3.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
  ...
  - [x] 2.4 Write property test for enable/disable mapping
    ...
    - [x] 2.4.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"

- [x] 3. Implement JellyfinClient library access and permissions
  - [x] 3.1 Implement set_library_access method
    ...
    - [x] 3.1.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
  ...
  - [x] 3.2 Write property test for library access configuration
    ...
    - [x] 3.2.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"

  - [x] 3.3 Implement update_permissions method
    ...
    - [x] 3.3.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
  ...
  - [x] 3.4 Write property test for permission mapping
    ...
    - [x] 3.4.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
  ...
  - [x] 3.5 Implement list_users method
    ...
    - [x] 3.5.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"

  - [x] 3.6 Write property test for user listing
    - **Property 7: User Listing Returns Complete Objects**
    - **Validates: Requirements 8.3**
    - [x] 3.6.1 Verify implementation adheres to coding guidelines in `.augment/rules/backend-dev-pro.md`
    - [x] 3.6.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
...
- [x] 5. Add API schemas for invitations
  - [x] 5.1 Add invitation request/response schemas to api/schemas.py
    ...
    - [x] 5.1.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
  ...
  - [x] 5.2 Add validation/redemption schemas
    ...
    - [x] 5.2.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
...
- [x] 6. Extend InvitationService with CRUD operations
  - [x] 6.1 Add code generation with collision handling
    ...
    - [x] 6.1.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
  ...
  - [x] 6.2 Write property test for code generation
    ...
    - [x] 6.2.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
  ...
  - [x] 6.3 Add server and library validation on create
    ...
    - [x] 6.3.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
  ...
  - [x] 6.4 Write property test for server/library validation
    ...
    - [x] 6.4.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
  ...
  - [x] 6.5 Add computed fields calculation
    ...
    - [x] 6.5.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
  ...
  - [x] 6.6 Write property test for computed fields
    ...
    - [x] 6.6.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
  ...
  - [x] 6.7 Add update method with immutable field protection
    ...
    - [x] 6.7.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
  ...
  - [x] 6.8 Write property test for immutable fields
    ...
    - [x] 6.8.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
  ...
  - [x] 6.9 Add delete method preserving users
    ...
    - [x] 6.9.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
  ...
  - [x] 6.10 Write property test for user preservation on delete
    ...
    - [x] 6.10.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
...
- [x] 7. Extend InvitationRepository with pagination and filtering
  - [x] 7.1 Add list_paginated method
    ...
    - [x] 7.1.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
...
- [x] 9. Implement InvitationController
  - [x] 9.1 Create InvitationController with CRUD endpoints
    ...
    - [x] 9.1.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
  ...
  - [x] 9.2 Add validation endpoint (public)
    ...
    - [x] 9.2.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
...
- [x] 10. Implement RedemptionService
  - [x] 10.1 Create RedemptionService with redeem method
    ...
    - [x] 10.1.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"

  - [x] 10.2 Write property test for user creation on all servers
    ...
    - [x] 10.2.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"

  - [x] 10.3 Write property test for use_count increment
    - **Property 16: Redemption Increments Use Count**
    - **Validates: Requirements 14.8**
    - [x] 10.3.1 Verify implementation adheres to coding guidelines in `.augment/rules/backend-dev-pro.md`
    - [x] 10.3.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"

  - [x] 10.4 Add expiration calculation from duration_days
    - Set expires_at on Identity and Users if duration_days set
    - _Requirements: 14.9_
    - [x] 10.4.1 Verify implementation adheres to coding guidelines in `.augment/rules/backend-dev-pro.md`
    - [x] 10.4.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"

  - [x] 10.5 Write property test for duration_days expiration
    - **Property 17: Duration Days Sets Expiration**
    - **Validates: Requirements 14.9**
    - [x] 10.5.1 Verify implementation adheres to coding guidelines in `.augment/rules/backend-dev-pro.md`
    - [x] 10.5.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"

  - [x] 10.6 Implement rollback on failure
    ...
    - [x] 10.6.1 Verify implementation adheres to coding guidelines in `.augment/rules/backend-dev-pro.md`
    - [x] 10.6.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"

  - [x] 10.7 Write property test for rollback behavior
...
- [x] 15. Implement UserController
  ...
  - [x] 15.3 Add enable/disable endpoints
  ...
  - [x] 15.4 Add delete endpoint
    - DELETE /api/v1/users/{id}
    - Return 204 on success, 404 if not found
    - _Requirements: 19.1, 19.6, 19.7_
    - [x] 15.4.1 Verify implementation adheres to coding guidelines in `.augment/rules/backend-dev-pro.md`
    - [x] 15.4.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"

  - [x] 15.5 Commit and push changes and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"

- [x] 16. Checkpoint - User management complete
  - Ensure all user management tests pass, ask the user if questions arise.

- [x] 17. Implement SyncService
  - [x] 17.1 Create SyncService with sync_server method
    ...
    - [x] 17.1.1 Verify implementation adheres to coding guidelines in `.augment/rules/backend-dev-pro.md`
    - [x] 17.1.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"

  - [x] 17.2 Write property test for discrepancy identification
    - **Property 22: Sync Identifies Discrepancies Correctly**
    - **Validates: Requirements 20.3, 20.4**
    - [x] 17.2.1 Verify implementation adheres to coding guidelines in `.augment/rules/backend-dev-pro.md`
    - [x] 17.2.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"

  - [x] 17.3 Write property test for idempotency
    - **Property 23: Sync Is Idempotent**
    - **Validates: Requirements 20.6**
    - [x] 17.3.1 Verify implementation adheres to coding guidelines in `.augment/rules/backend-dev-pro.md`
    - [x] 17.3.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"

  - [x] 17.4 Write property test for no modification
    - **Property 24: Sync Does Not Modify Users**
    - **Validates: Requirements 20.7**
    - [x] 17.4.1 Verify implementation adheres to coding guidelines in `.augment/rules/backend-dev-pro.md`
    - [x] 17.4.2 Run `uvx basedpyright@latest` and fix all type errors following Type Safety Guidelines (no warnings, no errors, no excuses) - see "Core rules"
